 ...
 * Modern slate surface layering — left canvas uses light workbench; center/right stay dark glass.
 */
  ...
  return (
    <div className="relative flex h-full min-h-0 flex-col overflow-hidden bg-transparent">
      <div className="relative mx-auto grid h-full w-full max-w-[1920px] min-h-0 flex-1 grid-cols-1 gap-3 px-3 py-2.5 sm:px-4 sm:py-3 lg:grid-cols-[minmax(0,44fr)_minmax(0,26fr)_minmax(0,30fr)] lg:gap-3 lg:overflow-hidden lg:px-5 lg:pb-4">
        <div className="min-h-[320px] overflow-hidden rounded-2xl border border-slate-200 bg-slate-100 shadow-[0_8px_28px_rgba(15,23,42,0.08)] lg:min-h-0 lg:h-full">
          {canvas}
        </div>
