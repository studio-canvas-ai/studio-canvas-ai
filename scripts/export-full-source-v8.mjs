/**
 * Concatenate project sources into Full_Source_Code_v8.txt
 * Includes Login modal UI final + social button scale-up + Meta/Facebook OAuth.
 * Run: node scripts/export-full-source-v8.mjs
 */
...
const OUT = join(ROOT, "Full_Source_Code_v8.txt");
...
stream.write(`# Studio Canvas AI ??Full Source Code Dump (v8)\n`);
stream.write(`# Includes AuthModal UI final (Google gradient, scaled social buttons) + Meta OAuth\n`);
