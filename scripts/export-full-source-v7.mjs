/**
 * Concatenate project sources into Full_Source_Code_v7.txt
 * Includes Kakao + Microsoft OAuth (custom:microsoft), auth bridge.
 * Run: node scripts/export-full-source-v7.mjs
 */
...
const OUT = join(ROOT, "Full_Source_Code_v7.txt");
...
stream.write(`# Studio Canvas AI ??Full Source Code Dump (v7)\n`);
stream.write(`# Includes Kakao + Microsoft OAuth (custom:microsoft) + auth bridge\n`);
