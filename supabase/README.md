...
7. Paste and run: [`migrations/20260909_partner_slots.sql`](./migrations/20260909_partner_slots.sql) (YouTuber partner slots + referrals + 10% commissions)
8. Confirm **Table Editor** shows `public.profiles` with `terms_agreed` / `terms_agreed_at` (and partner tables after step 7)
