...
/**
 * POST /api/shorts/chunk/complete
 * Finalize server-proxied multipart upload.
 */
export async function POST(req: Request) {
  try {
    ...
    const message = err instanceof Error ? err.message : "chunk_complete_failed";
    console.error("[shorts/chunk/complete]", message, err);
