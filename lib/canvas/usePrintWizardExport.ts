  ...
  const downloadWithProject = async (
    ...
    try {
      ...
      await downloadAndRemember({
        ...
        successMessage:
          quality === "ultra"
            ? "초고해상도 완성본·.sca를 기기에 저장하고, 수정용 .sca를 최근 파일·내 갤러리·템플릿 창고에 동기화했습니다."
            : quality === "high"
              ? "고화질 완성본·.sca를 기기에 저장하고, 수정용 .sca를 최근 파일·내 갤러리·템플릿 창고에 동기화했습니다."
              : "일반화질 완성본·.sca를 기기에 저장하고, 수정용 .sca를 최근 파일·내 갤러리·템플릿 창고에 동기화했습니다.",
      });
    } catch {
